...
<template>
  <div id="main" class="vh-100" :class="{'text-dark': theme == 'light', 'bg-secondary text-light': theme == 'dark'}" >
    <main class="mb-5 vh-100" :class="{'text-dark': theme == 'light', 'bg-secondary text-light': theme == 'dark'}">
      <Loader v-if="loading"/>
      <ErrorMessage v-if="error" error="error"/>
      <div v-if="movie" class="container p-5 mt-5 rounded h-75" :class="{'text-dark': theme == 'light', 'bg-secondary text-light': theme == 'dark'}">
        ...
        <div v-if="reviews" class="row mt-5" :class="{'text-dark': theme == 'light', 'bg-secondary text-light': theme == 'dark'}">
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body text-center" :class="{'text-dark': theme == 'light', 'bg-dark text-light': theme == 'dark'}">
